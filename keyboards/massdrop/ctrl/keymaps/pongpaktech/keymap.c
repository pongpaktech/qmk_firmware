...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        KC_SLEP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            KC_MUTE, KC_VOLD, KC_VOLU, \
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, G(KC_L), _______, _______, _______, \
        _______, _______, _______, _______, _______, MD_BOOT, NK_TOGG, _______, _______, _______, _______, MO(2)  ,                              L_BRI  , \
        _______, GUI_TOG, _______,                   L_T_ONF,                            L_LOW  , _______, L_MED  , L_HIGH ,      C(G(KC_LEFT)), L_BRD  , C(G(KC_RGHT)) \
    ),
...
led_instruction_t led_instructions[] = {
    ...
    //All LEDs use Cyan (.r = 0, .g = 192, .b = 255)
    //Keys,                     (id0  32 -   1: 1111 1111 1111 1111  1111 1111 1111 1111 = 0xFFFFFFFF)
    //Keys,                     (id1  64 -  33: 1111 1111 1111 1111  1111 1111 1111 1111 = 0xFFFFFFFF)
    //Keys & Edge               (id2  96 -  65: 1111 1111 1111 1111  1111 1111 1111 1111 = 0xFFFFFFFF)
    // (Just Keys)              (id2  87 -  65: 0000 0000 0111 1111  1111 1111 1111 1111 = 0x007FFFFF)
    // (Just Edge)              (id2  96 -  88: 1111 1111 1000 0000  0000 0000 0000 0000 = 0xFF800000)
    //Edge                      (id3 119 -  97: 0000 0000 0111 1111  1111 1111 1111 1111 = 0x007FFFFF)

    //Layer 1 keys blue         (id0  32 -   1: 1100 0000 0001 1110  1110 0000 0000 0001 = 0xC01EE001)
    // when active              (id1  64 -  33: 0000 1000 0000 0011  1000 0000 0000 0001 = 0x08038001)
    //                          (id2  96 -  65: 0000 0000 0111 1111  1010 1100 0011 0000 = 0x007FAC30)

    //Layer 2 keys red          (id0  32 -   1: 0000 0000 0000 0000  0100 0000 0000 0001 = 0x00004000)
    // when active              (id1  64 -  33: 0000 0000 0000 0000  0000 0000 0000 0000 = 0x00000000)
    //                          (id2  96 -  65: 0000 0000 0000 0000  0000 0000 0011 0000 = 0x00000030)

    /*
    // Normal Color
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = 0xFFFFFFFF, .id1 = 0xFFFFFFFF, .id2 = 0xFFFFFFFF, .id3 = 0x007FFFFF, .g = 192, .b = 255 },
    // Layer 1
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0xC01EE001, .id1 = 0x08038001, .id2 = 0x007FAC30, .b = 255, .layer = 1 },
    // Layer 2
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x00004000, .id2 = 0x00000030, .r = 255, .layer = 2 },
    */

    // Keys Cyan
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = 0xFFFFFFFF, .id1 = 0xFFFFFFFF, .id2 = 0x007FFFFF, .g = 192, .b = 255 },
    // Edge Spinrg Colors (Alternate Cyan & Green)
    // Cyan (nkro indicator)
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id2 = 0xAA800000, .id3 = 0x002AAAAA, .r = 0, .g = 192, .b = 255 },
    // Green
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id2 = 0x55000000, .id3 = 0x00555555, .r = 0, .g = 255, .b = 0 },
    // Layer 1
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0xC01EE001, .id1 = 0x08038001, .id2 = 0x007FAC30, .b = 255, .layer = 1 },
    // Layer 2
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x00004000, .id2 = 0x00000030, .r = 255, .layer = 2 },
